...
uartConfig:
	...
	mov 	r10, r1			@ Inteiro Bounddiv
	mov 	r11, r2			@ Fracionario Bounddiv
...
loop:	ldr 	r1, [r8, #UART_FR]		@ Load the data from the Flag Register
	...
	bic 	r1, r1, r0			@ Bit clear data from register 0 to register 1
	orr	r1, r1, r9			@ Add values from register 0 to register 1
	...
	str	r10, [r8, #UART_IBRD]		@ Write the value of register 0 to the Integer Baud Rate Divider
	str	r11, [r8, #UART_FBRD]		@ Write the value of register 0 to Fractional Baud Rate Divider
